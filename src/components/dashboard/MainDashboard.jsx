        ...
        <form onSubmit={handleSubmitParent} onChange={handleFormChange}>
          <div className="flex flex-col gap-y-5">
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="name">
                Nama Lengkap
              </Label>
              <Input placeholder="Masukan Nama Lengkap" id="name" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="phone_number">
                No Handphone
              </Label>
              <Input placeholder="Masukan No. Handphone" id="phone_number" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="nik">
                NIK
              </Label>
              <Input placeholder="NIK" id="nik" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="address">
                Alamat
              </Label>
              <Input placeholder="Alamat..." id="address" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="height">
                Tinggi Badan
              </Label>
              <Input placeholder="height" id="height" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
          ...
          <DialogFooter className="mt-5">
            <Button type="submit" className="bg-primaryFigma w-full text-white border border-primaryFigma hover:text-primaryFigma rounded-full shadow-md shadow-secondaryFigma">
              Save changes
            </Button>
          </DialogFooter>
        </form>
      ...
      <DialogContent className="bg-white font-poppins">
        ...
        <form onSubmit={handleSubmitChildren} onChange={handleFormChange}>
          <div className="flex flex-col gap-y-5">
            ...
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="age">
                Umur
              </Label>
              <Input placeholder="Umur" id="umur" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="age">
                Berat badan (Kg)
              </Label>
              <Input placeholder="20kg" id="weight" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="height">
                Tinggi badan (cm)
              </Label>
              <Input placeholder="160cm" id="height" className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`} />
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="birth_date">
                Tanggal Lahir
              </Label>
              <DatePicker selected={formPayload.birth_date} onChange={handleFormChange} dateFormat="yyyy-MM-dd" />
            </div>
            <div className="flex items-center gap-x-10 mx-5">
              <Label htmlFor="name">Jenis Kelamin</Label>
              <RadioGroup className="flex gap-x-5 mt-3 justify-start" defaultValue="Ya">
...
function TableActionButton() {
  return (
    <div className="flex gap-x-2">
      <Dialog>
        <DialogTrigger asChild>
          <button className={`bg-red-500 flex rounded-full items-center gap-x-1 text-white px-3 py-2`}>
