    ...
    <Dialog>
      ...
      <DialogContent className="bg-white">
        ...
        <Table>
          ...
          <TableBody>
            {growthRecord && growthRecord.map((record) => (
        ...
        <form onSubmit={handleSubmit} onChange={handleFormChange}>
          <div className="flex flex-col gap-y-5">
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="height_after">Tinggi Badan Terbaru</Label>
              <Input placeholder="height_after" id="height_after"
                     className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`}/>
            </div>
            <div className="flex items-center gap-4">
              <Label className="w-2/6" htmlFor="height_after">Berat Badan Terbaru</Label>
              <Input placeholder="weight_after" id="weight_after"
                     className={`w-full border-slate-400 rounded-full placeholder:text-slate-400`}/>
            </div>
          </div>
          <DialogFooter className="mt-5">
            <Button className="bg-primaryFigma w-full text-white border border-primaryFigma hover:text-primaryFigma rounded-full shadow-md shadow-secondaryFigma"
